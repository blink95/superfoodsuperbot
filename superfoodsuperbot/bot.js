...
client.on("message", async message => {
  ...
  if(command === "meal"){ 
      if (args.length == 0){
        message.channel.send("You can say something like '!meal menu' to get the first level of meal categories. Please follow the correct format and try again.");
        ...
        try{
          ...
          var first_arg = args[1].toLowerCase();
          if (first_arg == "menu"){
